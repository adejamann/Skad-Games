...
public Card(cardSuit suit, cardRank rank) {
   ...
   if (suit == cardSuit.DIAMONDS) {
      if (rank == cardRank.ACE) {
       ...
       } else if (cardRank.THREE.ordinal() == 2) {
       ...
       } else if (cardRank.FOUR.ordinal() == 3) {
       ...
       } else if (cardRank.FIVE.ordinal() == 4) {
       ...
       } else if (cardRank.SIX.ordinal() == 5) {
       ...
       } else if (cardRank.SEVEN.ordinal() == 6) {
       ...
       } else if (cardRank.EIGHT.ordinal() == 7) {
       ...
       } else if (cardRank.NINE.ordinal() == 8) {
       ...
       } else if (cardRank.TEN.ordinal() == 9) {
       ...
       } else if (cardRank.JACK.ordinal() == 10) {
       ...
       } else if (cardRank.QUEEN.ordinal() == 11) {
     ...
     } else if (cardSuit.SPADES.ordinal() == 1){
         ...
         playingcard.setFill(new ImagePattern(s1));
            ...
            Image s6 = new Image("https://upload.wikimedia.org/wikipedia/commons/thumb/d/d2/Playing_card_spade_6.svg/300px-Playing_card_spade_6.svg.png?20070326035401https://upload.wikimedia.org/wikipedia/commons/thumb/6/66/Playing_card_spade_7.svg/300px-Playing_card_spade_7.svg.png?20070326035421");
    ...
    } else if (cardSuit.HEARTS.ordinal() == 2) {
      if (cardRank.ACE.ordinal() == 0) {
